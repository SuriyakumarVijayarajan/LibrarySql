...
import com.library.pojo.FineHistory;

public class FineHistoryDao {

	public void insert(FineHistory fh1) {
		...
		pstmt.setString(1,fh1.getUser_name());
		pstmt.setInt(2,fh1.getFine_amount());
